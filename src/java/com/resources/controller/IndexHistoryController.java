...
public class IndexHistoryController {
    ...
    @ResponseBody
    public ModelAndView insertCustomerRankCustomer(@RequestParam(value = "pinNumber") String pinNumber, ModelMap mm, HttpSession session) {
        ...
        try {
            ...
            result = new CustomerRankCustomerFacade().depositPv((Integer) session.getAttribute("CUSTOMER_ID"), pinNumber);
        } catch (Exception e) {
