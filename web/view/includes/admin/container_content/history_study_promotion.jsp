            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        ...
                        <div class="input-group">
                            <div class="input-group-btn" data-toggle="tooltip" data-placement="left" data-title="Lựa chọn các trường tìm kiếm">
                                ...
                                <ul class="dropdown-menu dropdown-select dropdown-menu-left">
                                    ...
                                    <li><a><label><input type="checkbox" value="cus1_.userName" />Người bắt đầu</label></a></li>
                                    <li><a><label><input type="checkbox" value="cus2_.userName"  />Người kết thúc</label></a></li>
                                    <li class="divider"></li>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li><a controller='<c:url value="${PAGINATION.ROOT_CONTROLLER}${PAGINATION.childrenController}${PAGINATION.grandController}${PAGINATION.VIEW_INSERT}"/>' class="btn btn-default btn-sm btn-open-modal">Thêm mới <i class="fa fa-plus"></i></a></li>
                    </ul>
                </div><!-- /.navbar-collapse -->
            </div><!-- /.container-fluid -->
        </nav>
