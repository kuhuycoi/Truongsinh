                        ...
                        <div class="input-group">
                            <div class="input-group-btn" data-toggle="tooltip" data-placement="left" data-title="Lựa chọn các trường tìm kiếm">
                                ...
                                <ul class="dropdown-menu dropdown-select dropdown-menu-left">
                                    <li><a><label><input type="checkbox" value="cus1_.username" />Người nạp</label></a></li>
                                    <li><a><label><input type="checkbox" value="cus1_.usedDate" />Ngày nạp</label></a></li>
                                    <li><a><label><input type="checkbox" value="this_.pinNumber" />Tên NPP</label></a></li>
                                    <li><a><label><input type="checkbox" value="this_.pinType" />Loai PIN</label></a></li>
                                    <li><a><label><input type="checkbox" value="admin2_.username" />Người tạo</label></a></li>
                                    <li><a><label><input type="checkbox" value="this_.createdDate" />Ngày tạo</label></a></li>
                                    <li class="divider"></li>
