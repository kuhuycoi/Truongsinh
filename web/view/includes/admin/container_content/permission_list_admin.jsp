...
<div class="panel panel-default">
    <div class="panel-heading"> <nav class="navbar navbar-default" role="navigation">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        ...
                        <div class="input-group">
                            <div class="input-group-btn" data-toggle="tooltip" data-placement="left" data-title="Lựa chọn các trường tìm kiếm">
                                ...
                                <ul class="dropdown-menu dropdown-select dropdown-menu-left">
                                    <li><a><label><input type="checkbox" value="this_.lastName" />Tên</label></a></li>
                                    <li><a><label><input type="checkbox" value="this_.userName" />Tên đăng nhâp</label></a></li>
                                    <li class="divider"></li>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li><a href="#" class="btn-sm btn btn-default btn-open-modal" controller="<c:url value='${PAGINATION.ROOT_CONTROLLER}${PAGINATION.childrenController}${PAGINATION.grandController}${PAGINATION.VIEW_INSERT}'/>">Thêm mới quản trị viên <i class="fa fa-user-plus"></i></a></li>
