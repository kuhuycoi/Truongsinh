            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        ...
                        <div class="input-group">
                            <div class="input-group-btn" data-toggle="tooltip" data-placement="left" data-title="Lựa chọn các trường tìm kiếm">
                                ...
                                <ul class="dropdown-menu dropdown-select dropdown-menu-left">
                                    ...
                                    <li><a><label><input type="checkbox" value="this_.name" />Tên đại lý</label></a></li>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li><a href="#" class="btn btn-sm btn-default">Thêm mới <i class="fa fa-plus"></i></a></li>
                        <li><a href="#" class="btn btn-sm btn-default">Xuất excel <i class="fa fa-download"></i></a></li>
                    </ul>
                </div><!-- /.navbar-collapse -->
            </div><!-- /.container-fluid -->
        </nav>
